<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master"
    AutoEventWireup="true" CodeFile="Subject.aspx.cs" Inherits="Administrator_Subject" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("input[title=displayStatus]").click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../services/WebService.asmx/DisplaySubject",
                            ...
                            <ItemTemplate>
                                <tr id="<%#Eval("ID") %>">
                                    ...
                                    <td valign="middle" align="center">
                                        <a title='<%# Eval("ID")%>' href='<%#"SubjectAdd.aspx?ID="+Eval("ID")%>'>
                                            <%#Eval("NAME")%>
                                        </a>
                                    </td>
                                    <td valign="middle" align="center">
                                        <img src="../images/subject/<%#Eval("IMAGE")%>" alt="<%#Eval("NAME")%>" width="100" height="100" />
                                    </td>
                                    <td valign="middle" align="center">
                                        <%#Eval("SUMMURY")%>
                                    </td>
