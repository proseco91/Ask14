<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master"
    AutoEventWireup="true" CodeFile="AdministratorAdd.aspx.cs" Inherits="Administrator_AdministratorAdd" %>
                    ...
                    <div class="field">
                        <div class="label">
                            <label class="small-label">
                                Mật khẩu</label></div>
                        <div class="input">
                            <asp:TextBox ID="txtPassWord" CssClass="required medium" TextMode="Password" runat="server"
                                Width="300px"></asp:TextBox>
                        </div>
                    </div>
                    <div class="field">
                    ...
                    <div class="buttons">
                        <div class="button ">
                            ...
                            <input aria-disabled="false" role="button" class="ui-button ui-widget ui-state-default ui-corner-all"
                                value="Quay lại" onclick="location.href='../Administrator/Administrator.aspx'"
                                type="button" />
                            <input aria-disabled="false" role="button" class="ui-button ui-widget ui-state-default ui-corner-all"
