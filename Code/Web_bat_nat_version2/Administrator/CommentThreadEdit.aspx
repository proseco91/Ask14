<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="CommentThreadEdit.aspx.cs" Inherits="Administrator_CommentThreadEdit" %>
            ...
            <div class="form">
                <div class="fields">
                    <div class="field">
                        ...
                        <div class="input">
                            <asp:TextBox ID="txtTenBaiViet" runat="server" ReadOnly="true" />
                        </div>
                    </div>
                    <div class="field">
                        <div class="label">
                    ...
                    <div class="buttons">
                        <div class="button ">
                            ...
                            <input aria-disabled="false" role="button" class="ui-button ui-widget ui-state-default ui-corner-all"
                                value="Quay lại" onclick="location.href = '../Administrator/ListCommentThread.aspx'"
                                type="button" />
                        </div>
                    </div>
                </div>
