<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master"
    AutoEventWireup="true" CodeFile="Teacher.aspx.cs" Inherits="Administrator_Teacher" %>
                ...
                <table>
                    ...
                    <tbody>
                        <asp:Repeater runat="server" ID="rptData">
                            <ItemTemplate>
                                <tr id='<%#Eval("TEACHER_ID")%>'>
                                    <td align="center">
                                        <%#Container.ItemIndex+1 %>
                                    </td>
                                    <td valign="middle" align="center">
                                        <a title='<%# Eval("TEACHER_ID")%>' href='<%#"TeacherUpdate.aspx?TEACHER_ID="+Eval("TEACHER_ID")%>'>
                                            <%#Eval("NAME")%>
                                        </a>
                                    </td>
                                    <td align="center" style="vertical-align: middle">
                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%#"~/images/teacher/"+Eval("IMAGE")%>'
                                    ...
                                    <td align="center" class="last">
                                        <input type="checkbox" value="<%#Eval("TEACHER_ID")%>" class="item" />
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
