<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master"
    AutoEventWireup="true" CodeFile="SlideShowList.aspx.cs" Inherits="Administrator_SlideShowList" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("input[title=Display]").click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../services/TodayEnglishCenter.asmx/DisplaySlideShow",
                            ...
                            <ItemTemplate>
                                <tr id="<%#Eval("ID")%>">
                                    ...
                                    <td valign="middle" align="center">
                                        <a title='<%# Eval("ID")%>' href='<%#"SlideShowedit.aspx?ID="+Eval("ID")%>'>
                                            <%#Eval("NAME")%>
                                        </a>
                                    </td>
                                    <td valign="middle" align="center">
                                        <img src="../images/SlideShow/<%#Eval("IMAGE")%>" width="200px" height="100px" />
                                    </td>
                                    <td valign="middle" align="center">
                                        <%#Eval("LINK")%>
                                    </td>
