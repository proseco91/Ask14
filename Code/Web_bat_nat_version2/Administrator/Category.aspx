<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master"
    AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="Administrator_Category" %>
    ...
    <div id="content">
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("input[title=Display]").click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../services/WebService.asmx/DisplayCategoryStatus",
        ...
        <div class="box">
            ...
            <div class="title" style="background-color: #3B5998">
                <h5 id="txtTitle">Danh sách danh mục
                </h5>
            </div>
            ...
            <div class="first-action">
                <div class="button">
                    <asp:Button aria-disabled="false" role="button" CssClass="add ui-button ui-widget ui-state-default ui-corner-all"
                        Text="Thêm Mới" runat="server" ID="btnAdnew1" OnClick="Button1_Click" />
            ...
            <div class="table">
                            ...
                            <ItemTemplate>
                                <tr id='<%#Eval("ID")%>'>
                                    ...
                                    <td valign="middle" align="center">
                                        <a title='<%# Eval("ID")%>' href='<%#"CategoryEdit.aspx?ID="+Eval("ID")%>'>
                                            <%#Eval("NAME")%>
                                        </a>
                                    </td>
                                    <td valign="middle" align="center">
                                        <asp:Literal ID="ltParent" runat="server" />
                                    </td>
                                    <td valign="middle" align="center">
                                        <%#Eval("Meta_keywords")%>
                                    </td>
                ...
                <div class="action">
                    <div class="button">
                        <asp:Button aria-disabled="false" role="button" CssClass="add ui-button ui-widget ui-state-default ui-corner-all"
                            Text="Thêm Mới" runat="server" ID="Button1" OnClick="Button1_Click" />
