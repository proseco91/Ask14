<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="ListCommentThread.aspx.cs" Inherits="Administrator_ListCommentThread" %>
    ...
    <div id="content">
        ...
        <div class="box">
            ...
            <div class="title" style="background-color: #3B5998">
                <h5 id="txtTitle">Danh sách Comment Thread
                </h5>
            </div>
                        ...
                        <asp:Repeater runat="server" ID="rptData">
                            <ItemTemplate>
                                <tr id='<%#Eval("ID") %>'>
                                    ...
                                    <td valign="middle" align="center">
                                        <a href="ThreadEdit.aspx?ID=<%#Eval("ForumID")%>" target="_blank">
                                            <%#Eval("Article_Name")%>
                                        </a>
                                    </td>
                                    <td valign="middle" align="center">
