<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master"
    AutoEventWireup="true" CodeFile="PictureList.aspx.cs" Inherits="Administrator_PictureList" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("input[title=Display]").click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../services/TodayEnglishCenter.asmx/DisplayPicture",
                            ...
                            <ItemTemplate>
                                <tr id='<%#Eval("ID")%>'>
                                    ...
                                    <td valign="middle" align="center">
                                        <a title='<%# Eval("ID")%>' href='<%#"PictureEdit.aspx?ID="+Eval("ID")%>'>
                                            <%#Eval("TITLE")%>
                                        </a>
                                    </td>
                                    <td align="center" style="vertical-align: middle">
                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%#"~/Images/photoView/"+Eval("AVARTA")%>'
