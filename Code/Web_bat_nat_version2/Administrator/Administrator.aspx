<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage.master"
    AutoEventWireup="true" CodeFile="Administrator.aspx.cs" Inherits="Administrator_Administrator" %>
                            ...
                            <ItemTemplate>
                                <tr id="<%#Eval("ADMIN_ID") %>">
                                    ...
                                    <td valign="middle" align="center">
                                        <a title='<%# Eval("ADMIN_ID")%>' href='<%#"AdministratorEdit.aspx?ADMIN_ID="+Eval("ADMIN_ID")%>'>
                                            <%#Eval("FULL_NAME")%>
                                        </a>
                                    </td>
                                    <td valign="middle" align="center">
                                    ...
                                    <td align="center" class="last">
                                        <input type="checkbox" value="<%#Eval("ADMIN_ID")%>" class="item" />
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
