<%@ WebHandler Language="C#" Class="HistoryComment" %>

using System;
using System.Web;
using System.Data;

public class HistoryComment : IHttpHandler
{
    ...
    private DataTable GetData(int from, int to, int CustomerID)
    {
        return objForum.HistoryComment_PaggingData(from, to, CustomerID);
    }
