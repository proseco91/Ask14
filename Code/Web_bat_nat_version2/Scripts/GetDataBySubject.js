GetDataBySubject = {
    ...
    getBySubject: function (SubjectID, numberitem, iSelect) {
        ...
        $.ajax({
            type: "GET",
            url: "../ashx/GetDataBySubject.ashx?from=" + from + "&to=" + to + "&SubjectID=" + SubjectID,
            sync: true,
            datatype: "XML",
            success: function (XmlData) {
                ...
                if (iTotalItem == '') {
                    ...
                    if (iTotalItem > numberitem) {
                        ...
                        htmPaging = LT_DrawPaging(iSelect, numberitem, iTotalItem, "GetDataBySubject.getBySubject(" + SubjectID + "," + numberitem + ",");
