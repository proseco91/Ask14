GetDataNewsByTags = {
    ...
    getnews: function (TagID, numberitem, iSelect) {
        ...
        $.ajax({
            type: "GET",
            url: "ashx/GetDataNewsByTags.ashx?from=" + from + "&to=" + to + "&TagID=" + TagID,
            sync: true,
            datatype: "XML",
            success: function (XmlData) {
                ...
                if (iTotalItem == '') {
                    ...
                    for (var i = 0; i < iCount; i++) {
                        var id = $(Xml).find("Row[id ='" + i + "']").find("ID").text().trim();
                    ...
                    if (iTotalItem > numberitem) {
                        ...
                        htmPaging = LT_DrawPaging(iSelect, numberitem, iTotalItem, "GetDataNewsByTags.getnews(" + TagID + "," + numberitem + ",");
