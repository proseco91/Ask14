function LT_DrawPaging(iSelectPage, NumberOfItemPerPage, totalItem, funcDrawPage) {
    ...
    if (totalPage > 1) {
        ...
        if (iSelectPage > 1) {
            strPage += '<li class="paging-img" onclick="' + funcDrawPage + (1) + ');"><img alt="" src="images/first-pager-s.png"/></li>';
            strPage += '<li class="paging-img pagingprev" onclick="' + funcDrawPage + (iSelectPage - 1) + ');"><img alt="" src="images/prev-pager-s.png"/>';
            strPage += '</li>';
        } else {
            strPage += '<li class="first-selected paging-img"><img alt="" src="images/first-pager.png"/></li>';
            strPage += '<li class="first-selected paging-img pagingprev"><img alt="" src="images/prev-pager.png"/>';
            strPage += '</li>';
        }
        ...
        if (iSelectPage < 2 && totalPage > 4)
            strPage += '<li class="pagingdeactive" id="numberPage' + (iSelectPage + 4) + '" onclick="' + funcDrawPage + (iSelectPage + 4) + ');">' + (iSelectPage + 4) + '</li>';
        if (iSelectPage < totalPage) {
            strPage += '<li class="paging-img pagingnext" onclick="' + funcDrawPage + (iSelectPage + 1) + ');"><img alt="" src="images/next-pager.png"/></li>';
            strPage += '<li class="paging-img" onclick="' + funcDrawPage + (totalPage) + ');"><img alt="" src="images/last-pager.png"/></li>';
            strPage += '</ul>';
        }
        else {
            strPage += '<li class="last-selected paging-img pagingnext"><img alt="" src="images/next-pager-s.png"/></li>';
            strPage += '<li class="last-selected paging-img"><img alt="" src="images/last-pager-s.png"/></li>';
            strPage += '</ul>';
        }
    }
    return strPage;
...
function LT_DrawPagingEmotion(iSelectPage, NumberOfItemPerPage, totalItem, funcDrawPage) {
    ...
    if (totalPage > 1) {
        if (iSelectPage > 1) {
            strPage += '<a onclick="' + funcDrawPage + (iSelectPage - 1) + ');"><img alt="" src="images/emotion-previos.png"/>';
            strPage += '</a>';
        } else {
            strPage += '<a><img alt="" src="images/emotion-previos.png"/></a>';            
        }

        if (iSelectPage < totalPage) {
            strPage += '<a onclick="' + funcDrawPage + (iSelectPage + 1) + ');"><img alt="" src="images/emotion-next.png"/></a>';
        }
        else {
            strPage += '<a><img alt="" src="images/emotion-next.png"/></a>';
        }
    }
    return strPage;
}
