GetDataBySchoolID = {
    ...
    GetDataBySchool: function (SchoolID, numberitem, iSelect) {
        ...
        $.ajax({
            type: "GET",
            url: "../ashx/GetDataBySchoolID.ashx?from=" + from + "&to=" + to + "&SchoolID=" + SchoolID,
            sync: true,
            datatype: "XML",
            success: function (XmlData) {
                ...
                if (iTotalItem == '') {
                    ...
                    if (iTotalItem > numberitem) {
                        ...
                        htmPaging = LT_DrawPaging(iSelect, numberitem, iTotalItem, "GetDataBySchoolID.GetDataBySchool(" + SubjectID + "," + numberitem + ",");
